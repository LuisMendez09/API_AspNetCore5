...
namespace netCoreApi.Utilidades
{
    public class AlmacenadorArchivosLocal : IAlmacenadorArchivos
    {
        ...
        public async Task<string> GuardarArchivo(string contenedor, IFormFile archivo)
        {
            ...
            var nomreArchivo = $"{Guid.NewGuid()}{extension}";
            ...
            string ruta = Path.Combine(folder, nomreArchivo);
            ...
            var rutaParaDb = Path.Combine(urlActual, contenedor, nomreArchivo).Replace("\\","/");
            return rutaParaDb;
        }
    }
}
